...
Define your own schemas extending `UserSchema` and `CreateUserSchema` to include custom fields like `display_name` and `phone`, then pass them to the adapter. See [Custom Schemas](https://mdfarhankc.github.io/fastapi-fullauth/adapters/#custom-schemas) or the [API Reference](https://mdfarhankc.github.io/fastapi-fullauth/api-reference/index.md).
...
See [Protected Routes](https://mdfarhankc.github.io/fastapi-fullauth/auth/dependencies/index.md) for all dependency types.

## What to read next

- **[Architecture](https://mdfarhankc.github.io/fastapi-fullauth/architecture/index.md)**: understand how the library works (tokens, adapters, protection layers)
- **[Configuration](https://mdfarhankc.github.io/fastapi-fullauth/configuration/index.md)**: all config options with production examples
- **[OAuth2 Social Login](https://mdfarhankc.github.io/fastapi-fullauth/oauth/index.md)**: add Google, GitHub, Discord, GitLab login
- **[Passkeys](https://mdfarhankc.github.io/fastapi-fullauth/passkeys/index.md)**: passwordless login with biometrics
- **[Event Hooks](https://mdfarhankc.github.io/fastapi-fullauth/auth/hooks/index.md)**: send emails, log events, sync external systems
- **[Rate Limiting](https://mdfarhankc.github.io/fastapi-fullauth/security/rate-limiting/index.md)**: protect your endpoints
- **[Testing](https://mdfarhankc.github.io/fastapi-fullauth/testing/index.md)**: test your auth-protected routes
- **[Troubleshooting](https://mdfarhankc.github.io/fastapi-fullauth/troubleshooting/index.md)**: common errors and solutions
