...
A minimal setup needs only `UserMixin` and `RefreshTokenMixin`. For integer or string user keys, see [Choosing a primary key type](https://mdfarhankc.github.io/fastapi-fullauth/adapters/#choosing-a-primary-key-type).
