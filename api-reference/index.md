...
Pydantic Settings class. See [Configuration](https://mdfarhankc.github.io/fastapi-fullauth/configuration/index.md) for all options.
...
Returned by `GET /auth/sessions`. See [Session Management](https://mdfarhankc.github.io/fastapi-fullauth/auth/sessions/index.md).
