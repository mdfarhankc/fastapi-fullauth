...
| POST   | `/admin/assign-role`              | admin    | superuser     |
| POST   | `/admin/remove-role`              | admin    | superuser     |
| POST   | `/admin/assign-permission`        | admin    | superuser     |
| POST   | `/admin/remove-permission`        | admin    | superuser     |
| GET    | `/admin/role-permissions/{role_name}` | admin | superuser    |
